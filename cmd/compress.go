...
invalid-utf16: invalid UTF-16(output format is UTF-16 Little Endian. Sometimes it contains invalid UTF-16)
base64: base64(output format is UTF-8)
utf16: valid UTF-16(output format is UTF-16 Little Endian)
